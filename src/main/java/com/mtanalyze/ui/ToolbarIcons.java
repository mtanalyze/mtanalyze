...
public final class ToolbarIcons {
    ...
    public static Icon arrowLeft()  { return arrowIcon(13, 8, 3, 8, new int[]{6, 1, 6},    new int[]{4, 8, 12}); }
    public static Icon arrowRight() { return arrowIcon(3, 8, 13, 8, new int[]{10, 15, 10}, new int[]{4, 8, 12}); }
    public static Icon arrowUp()    { return arrowIcon(8, 13, 8, 3, new int[]{4, 8, 12},   new int[]{6, 1, 6}); }
    public static Icon arrowDown()  { return arrowIcon(8, 3, 8, 13, new int[]{4, 8, 12},   new int[]{10, 15, 10}); }

    /** Straight shaft (x1,y1)-(x2,y2) with a triangular {@code (headX, headY)} arrowhead. */
    private static Icon arrowIcon(int x1, int y1, int x2, int y2, int[] headX, int[] headY) {
        return makeMenuIcon((g, c) -> {
            g.setColor(c);
            g.setStroke(new BasicStroke(1.6f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND));
